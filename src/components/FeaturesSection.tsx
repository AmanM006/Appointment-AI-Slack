        ...
        <div ref={featuresRef} className="slide-up">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div className="glass-card p-6 rounded-xl transition-all duration-300 hover:shadow-xl">
              ...
              <h3 className="text-xl font-semibold text-gray-900 mb-2">Google Calendar Sync</h3>
            ...
            <div className="glass-card p-6 rounded-xl transition-all duration-300 hover:shadow-xl">
              ...
              <h3 className="text-xl font-semibold text-gray-900 mb-2">AI Voice Commands</h3>
              <p className="text-gray-600">
          ...
          <div id="how-it-works" className="mt-32">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              ...
              <div className="glass-card p-8 rounded-xl relative hover:shadow-xl transition-all duration-300">
                ...
                <h3 className="text-xl font-semibold text-gray-900 mb-4 pt-4">Connect Google Sheet</h3>
                <p className="text-gray-600">
              ...
              <div className="glass-card p-8 rounded-xl relative hover:shadow-xl transition-all duration-300">
                ...
                <h3 className="text-xl font-semibold text-gray-900 mb-4 pt-4">Set AI Triggers</h3>
                <p className="text-gray-600">
              ...
              <div className="glass-card p-8 rounded-xl relative hover:shadow-xl transition-all duration-300">
                ...
                <h3 className="text-xl font-semibold text-gray-900 mb-4 pt-4">Automate Everything</h3>
                <p className="text-gray-600">
